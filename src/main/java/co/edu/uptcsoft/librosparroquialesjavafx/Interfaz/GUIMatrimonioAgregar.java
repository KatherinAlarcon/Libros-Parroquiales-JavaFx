...
public class GUIMatrimonioAgregar extends Application {
    ...
    public void start(Stage stage) {
        ...
        //menu horizontal
        titulo = new Label("Matrimonio/Agregar");
        ...
        btnAgregar.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                TextField[] requiredFields = {
                        libroText, folioText, numeroText, nombreNoviaText, nombreNovioText, apellidoNovioText, apellidoNoviaText
                };

                Validator validator = new Validator();
                boolean allFieldsFilled = validator.areTextFieldsFilled(requiredFields) &&
                        validator.areComboBoxesAndDatesValid(
                                estadoCivilNovio, ministroComboBox, fechaNacimientoNovio, fechaBautismoNovio,
                                estadoCivilNovia, daFe, fechaNacimientoNovia, fechaBautismoNovia
                        );

                boolean guardarPersistencia = actualizarMatrimonioDesdeInterfaz();

                if (allFieldsFilled && guardarPersistencia) {
                    if (fechaNacimientoNovio.getValue().isAfter(fechaBautismoNovio.getValue()) ||
                            fechaNacimientoNovia.getValue().isAfter(fechaBautismoNovia.getValue())) {
        ...
        stage.setTitle("Matrimonio / Agregar");
